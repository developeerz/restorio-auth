...
// SaveUser provides a mock function with given fields: telegram, userJson
func (_m *Cache) SaveUser(telegram string, userJson []byte) error {
...
// SaveVerificationCode provides a mock function with given fields: telegram, code
func (_m *Cache) SaveVerificationCode(telegram string, code int) error {
	ret := _m.Called(telegram, code)

	if len(ret) == 0 {
		panic("no return value specified for SaveVerificationCode")
	}
